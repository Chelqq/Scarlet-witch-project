...
$(document).ready(function() {
    ...
    0 != $(".navbar[color-on-scroll]").length && (blackDashboard.checkScrollForTransparentNavbar(), $(window).on("scroll", blackDashboard.checkScrollForTransparentNavbar));
...
$(window).resize(function() {
    if (seq = seq2 = 0, 0 == $full_screen_map.length && 0 == $(".bd-docs").length) {
        ...
        $navbar.hasClass("bg-white") && 991 < $(window).width() ? $navbar.removeClass("bg-white").addClass("navbar-transparent") :
        $navbar.hasClass("navbar-transparent") && $(window).width() < 991 && "false" != a && $navbar.addClass("bg-white").removeClass("navbar-transparent");
    }
}),
